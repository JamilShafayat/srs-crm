...
class RegistrationDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { full_name: { required: true, type: () => String, minLength: 3, maxLength: 200 }, phone: { required: true, type: () => String, minLength: 10, maxLength: 200 }, password: { required: true, type: () => String, minLength: 6, maxLength: 200 } };
    }
}
__decorate([
...
], RegistrationDto.prototype, "full_name", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
        type: String,
