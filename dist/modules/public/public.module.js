...
exports.PublicModule = exports.PublicModuleList = void 0;
const common_1 = require("@nestjs/common");
const registrations_module_1 = require("./registrations/registrations.module");
exports.PublicModuleList = [registrations_module_1.RegistrationsModule];
let PublicModule = class PublicModule {
};
PublicModule = __decorate([
    (0, common_1.Module)({
        imports: exports.PublicModuleList,
    })
], PublicModule);
